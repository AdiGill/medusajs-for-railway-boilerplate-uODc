...
const checkBackend = () => {
  const url = (process.env.NEXT_PUBLIC_MEDUSA_BACKEND_URL || 'https://medusajs-backend-production-7592.up.railway.app') + '/store/product-categories?expand=category_children';
